...
PySimplicial.utils.visualize_triangulation_3D(tetrahedron, type="Tetrahedrons", enable_random_face_colors=False)

print("tetrahedron with 1-4 move")
new_tetrahedron_1_4 = PySimplicial.utils.move_1_4(tetrahedron)
visualize_tetrahedron_1_4 = PySimplicial.utils.visualize_triangulation_3D(new_tetrahedron_1_4, type="Tetrahedrons", enable_random_face_colors=False)
